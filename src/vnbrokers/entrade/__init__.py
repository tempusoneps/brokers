...
class Broker:
    def __init__(self, symbol, investor_id, investor_account_id, bearer_token, bank_margin_portfolio_id=None):
        self.symbol = symbol
        self.bankMarginPortfolioId = bank_margin_portfolio_id or BANK_MARGIN_PORTFOLIO_ID
